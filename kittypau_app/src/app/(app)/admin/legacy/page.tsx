                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <button
                    ...
                    disabled={
                      ...
                      (permissions ? !permissions.can_run_health_check : false)
                    }
                    onClick={async () => {
            ...
            <section className="surface-card freeform-rise order-2 px-4 py-4 sm:px-6 sm:py-5">
              ...
              <div className="mt-4 rounded-[var(--radius)] border border-slate-200 bg-white px-4 py-3">
                ...
                <div className="mt-2 grid gap-2 text-xs text-slate-700 md:grid-cols-4">
                  ...
                  <p>
                    <span className="font-semibold">Costo/usuario activo:</span>{" "}
            ...
            <div className="flex flex-col gap-6">
                  ...
                  <section className="surface-card freeform-rise order-12 px-4 py-4 sm:px-6 sm:py-5">
                    ...
                    <div className="mt-4 grid gap-3 md:grid-cols-4">
                      <div className="rounded-[var(--radius)] border border-slate-200 bg-white px-4 py-3">
                        ...
                        <p className="mt-2 text-xl font-semibold text-slate-900">
                          USD{" "}
                          {(financeSummary?.bom_unit_cost_usd ?? 0).toFixed(2)}
                        </p>
                      </div>
                      <div className="rounded-[var(--radius)] border border-slate-200 bg-white px-4 py-3">
                        <p className="text-[11px] uppercase tracking-[0.2em] text-slate-400">
                      ...
                      <div className="rounded-[var(--radius)] border border-slate-200 bg-white px-4 py-3">
                        ...
                        <p className="mt-1 text-xs text-slate-500">
                          {formatClp(
                            (financeSummary?.unit_cost_usd ?? 0) * fxClpPerUsd,
                          )}{" "}
                          ·{" "}
                          {formatJpy(
                            (financeSummary?.unit_cost_usd ?? 0) * fxJpyPerUsd,
                          )}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="mt-3 rounded-[var(--radius)] border border-slate-200 bg-slate-50 px-4 py-3 text-xs text-slate-600">
                      ...
                      <p className="mt-1">
                        ...
                        {(financeBreakEven?.fixed_monthly_usd ?? 0).toFixed(2)}{" "}
                        · Precio plato:{" "}
                          ...
                          {financePlans.length ? (
                            financePlans.map((plan) => (
                              ...
                              >
                                ...
                                <td className="px-2 py-2">
                                  {plan.limit_label ?? plan.usage_label ?? "-"}
                                </td>
                              </tr>
                            ))
                          ) : (
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td
                                  ...
                                  colSpan={5}
                                >
                                  Impresión: {selectedKpclCatalog.print_grams}g
                                  · {selectedKpclCatalog.print_hours}h · USD{" "}
                              ...
                              <tr>
                                ...
                                >
                                  ...
                                  {selectedKpclRuntimeSim.deviceMb.toFixed(2)}{" "}
                                  MB de{" "}
                                  {selectedKpclRuntimeSim.totalMb.toFixed(2)} MB
                                  totales KPCL.
                                </td>
                              </tr>
                              <tr>
                    ...
                    <p className="mt-3 text-[11px] text-slate-400">
                      ...
                      {financeSummary?.generated_at
                        ? new Date(financeSummary.generated_at).toLocaleString(
                            "es-CL",
                            {
                              day: "2-digit",
                              month: "2-digit",
                    ...
                    <div className="mt-4 rounded-[var(--radius)] border border-slate-200 bg-white p-3">
                      ...
                      <div className="md:hidden space-y-2">
                        {continuityChart.rows.map((row) => {
                          ...
                          const isOnline =
                            row.points[row.points.length - 1]?.online === true;
                          return (
                            <div
              ...
              {infraExpanded ? (
                ...
                <section className="surface-card freeform-rise order-11 px-4 py-3 sm:px-6 sm:py-4">
                  <p className="text-xs text-slate-500">
                    Infraestructura colapsada. Actívala desde el header para ver
                    telemetría técnica completa.
                  </p>
                </section>
              )}
