                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <button
                      ...
                      disabled={
                        ...
                        (permissions
                          ? !permissions.can_run_health_check
                          : false)
                      }
                      onClick={async () => {
                        if (permissions && !permissions.can_run_health_check) {
                          setHealthCheckStatus((prev) => ({
                            ...prev,
                            message:
                              "Tu rol no permite ejecutar el health-check.",
                          }));
                          return;
                        }
                        const token = await getValidAccessToken();
              ...
              <section className="surface-card freeform-rise order-2 px-4 py-4 sm:px-6 sm:py-5">
                ...
                >
                  ...
                  <div className="mt-2 grid gap-2 text-xs text-slate-700 md:grid-cols-4">
                    ...
                    <p>
                      ...
                      USD {scalingMetrics.costPerActive.toFixed(2)}
                    </p>
                    <p>
                      <span className="font-semibold">Costo por 1.000:</span>{" "}
                      USD {scalingMetrics.costPer1000.toFixed(2)}
                    </p>
                    <p>
                ...
                <div className="mt-3 rounded-[var(--radius)] border border-slate-200 bg-white px-4 py-3">
                  ...
                  <p className="mt-2 text-[11px] text-slate-500">
                    Proyección con crecimiento MRR del 3% mensual y múltiplo
                    ajustado por LTV/CAC y churn.
                  </p>
                </div>
                <div className="mt-3 grid gap-3 lg:grid-cols-3">
                  <article className="rounded-[var(--radius)] border border-slate-200 bg-white px-4 py-3 text-xs text-slate-700">
                    ...
                    <p className="mt-1">
                      Objetivo: ingreso recurrente y LTV/CAC &gt; 3.
                    </p>
                    <p className="mt-1 text-slate-500">
                      KPI crítico: LTV/CAC y MRR.
                    </p>
                  </article>
                  <article className="rounded-[var(--radius)] border border-slate-200 bg-white px-4 py-3 text-xs text-slate-700">
                    <p className="font-semibold text-slate-900">
