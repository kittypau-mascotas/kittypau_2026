 ...
 * "Valorización SaaS" (`modelos-negocio-card.tsx`), `SectionStatusCard`
 ...
 * `section-status-card.tsx`, deliberado, ver ese archivo), `resolveKpclCatalog`.
 */
                  ...
                  <article className="surface-card freeform-rise px-6 py-5">
                    ...
                    <div className="mt-4 overflow-x-auto">
                      <table className="min-w-full text-left text-xs text-slate-600">
                        ...
                        <tbody>
                          {(registrationSummary?.pending_recent ?? [])
                            .length ? (
                            (registrationSummary?.pending_recent ?? []).map(
                              (row) => (
                                <tr
                                  key={row.id}
                                  className="border-b border-slate-100"
                          ...
                          <tbody>
                            {bridges.map((bridge) => (
                              ...
                              >
                                ...
                                <td className="px-2 py-2">
                                  {bridge.last_seen
                                    ? new Date(bridge.last_seen).toLocaleString(
                                        "es-CL",
                                      )
                                    : "-"}
                                </td>
