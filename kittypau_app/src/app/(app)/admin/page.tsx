 ...
 * (`infraestructura-card.tsx` — batch 2, 2026-08-13), `SectionStatusCard`
                ...
                <section className="surface-card freeform-rise order-8 px-4 py-4 sm:px-6 sm:py-5">
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    <div>
                      ...
                      <p className="mt-1 text-xs text-slate-500">
                        Ejecuta validaciones de vistas, catálogos y fuentes del
                        dashboard.
                      </p>
                      <SectionStatusCard
                    ...
                    <button
                      ...
                      disabled={
                        testsRunning ||
                        (permissions ? !permissions.can_run_test_suite : false)
                      }
