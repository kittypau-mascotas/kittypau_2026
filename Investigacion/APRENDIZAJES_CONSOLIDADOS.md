...
|-----------|-------|----------|-------|-------|
| `readings_delta.parquet` | 134,164 | 25 (18 features + metadatos) | Abr–Jun 2026 | `Ciclo_Alpha_v1/Exploracion_Gamma_Delta_2026/Ciclo_Delta/fase_1_datos/data/processed/` |
| `X_scaled.parquet` | 134,164 | 18 | Abr–Jun 2026 | misma ruta |
| `readings_raw.parquet` (Alpha) | 124,682 | — | Abr 8–May 1 | `Ciclo_Alpha_v1/fase_1_extraccion/data/` |
...
Ruta: `Ciclo_Alpha_v1/Exploracion_Gamma_Delta_2026/Ciclo_Delta/fase_3_anomalias/outputs/anomalias_detectadas.csv`

Los **2 candidatos nuevos de servido** identificados en Delta están en:
`Ciclo_Alpha_v1/Exploracion_Gamma_Delta_2026/Ciclo_Delta/fase_4_validacion/outputs/candidatos_servido_delta_nuevos.csv`
...
| Asset | Estado | Ruta |
|-------|--------|------|
| `readings_delta.parquet` (134k lecturas Abr–Jun) | ✅ | `Ciclo_Alpha_v1/Exploracion_Gamma_Delta_2026/Ciclo_Delta/fase_1_datos/data/processed/` |
| `X_scaled.parquet` (18 features, escaladas) | ✅ | misma ruta |
| `sessions_labeled.parquet` (Alpha Exp 06) | ✅ | `Ciclo_Alpha_v1/fase_1_extraccion/data/` |
| `readings_raw.parquet` (Alpha Exp 06) | ✅ | `Ciclo_Alpha_v1/fase_1_extraccion/data/` |
| `app_anotacion_gamma.py` | ✅ | `Ciclo_Alpha_v1/Exploracion_Gamma_Delta_2026/Ciclo_Gamma/` |
| `anomalias_detectadas.csv` (676 H/C/U) | ✅ | `Ciclo_Alpha_v1/Exploracion_Gamma_Delta_2026/Ciclo_Delta/fase_3_anomalias/outputs/` |
| `candidatos_servido_delta_nuevos.csv` (2) | ✅ | `Ciclo_Alpha_v1/Exploracion_Gamma_Delta_2026/Ciclo_Delta/fase_4_validacion/outputs/` |
| Modelos LGBM Exp 06 (producción) | ✅ | `Ciclo_Alpha_v1/fase_3_modelos/models/` |
| Modelos LGBM Gamma G-01 a G-05 | ✅ | `Ciclo_Alpha_v1/Exploracion_Gamma_Delta_2026/Ciclo_Gamma/models/` |
| Pipeline extracción Fase 1 | ✅ | `Ciclo_Alpha_v1/fase_1_extraccion/` |
| `exp_10_colab.py` + resultados NN | ✅ | `Ciclo_Alpha_v1/experiments/exp_10_colab/` |
...
*Fuentes: APRENDIZAJES_GAMMA_DELTA.md · A1_EXPERIMENT_TRACKER.md · ESTADO_PROYECTO_Y_NUEVA_DIRECCION.md · A1_EXPERIMENTOS_DETALLE.md*
