# Ciclo Alpha v2 — Motor Matemático (Shape Features)

> Fusión de las features clásicas F00, la evolución a 102 features en 15 familias + Evidence Engine, y la recopilación técnica detallada de la app.


---


<!-- ==== fusionado desde av2_04_MOTOR_MATEMATICO.md ==== -->
...
> Ver [[av2_00_INDICE_Y_VISION_GENERAL]] para el índice completo.
...
> Ver [[av2_04_MOTOR_MATEMATICO]] para el detalle completo del motor v2.
...
`tpl_doble_rampa` resultó ser el mejor discriminador de toda la suite (5.76σ A/S), superando a `sim_alimentacion`. Ver [[av2_04_MOTOR_MATEMATICO]] para el detalle.
...
- [[av2_07_RESULTADOS_Y_BENCHMARKS]] — Estadísticas completas de las 417 anotaciones (F00 + top features v2)
- [[av2_04_MOTOR_MATEMATICO]] — Motor v2: 105 features en 15 familias + Evidence Engine
- [[av2_08_APP_ANOTACION]] — Visualización en la app (Tab 4 Umbrales + Tab 5 Motor Matemático)
...
Ver [[av2_00_INDICE_Y_VISION_GENERAL]] para el estado actual. Ver [[av2_04_MOTOR_MATEMATICO]] para las features de la v1.
...
- [[av2_04_MOTOR_MATEMATICO]] — Features actuales de la v1 (detalle matemático)
- [[av2_06_UMBRALES_Y_REGLAS]] — Clasificador determinístico v1.2 (umbrales.json)
- [[av2_07_RESULTADOS_Y_BENCHMARKS]] — Base empírica para calibrar las nuevas features
