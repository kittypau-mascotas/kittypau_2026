...
13. No modificar ningun archivo dentro de `Ciclo Gamma/` ni `Ciclo Alpha/`.
...
| Documento | Relacion |
|---|---|
| `../Ciclo Gamma/instructivo.md` | Guia maestra del ciclo activo (Gamma) |
| `../Ciclo Gamma/EXPERIMENT_TRACKER_GAMMA.md` | Estado y metricas de Gamma |
| `../Ciclo Gamma/GLOSARIO_GAMMA.md` | Terminos de Gamma |
