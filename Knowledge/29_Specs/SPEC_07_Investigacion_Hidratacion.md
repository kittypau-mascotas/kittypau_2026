...
title: SPEC 07 — Reorganización de Investigacion + roadmap para investigar hidratación
type: spec
status: draft
owner: Mauro
created: 2026-08-13
...
# SPEC 07 — Reorganización de Investigacion + roadmap para investigar hidratación
...
## 1. Mapa actual de `Investigacion/` (verificado en esta sesión)
