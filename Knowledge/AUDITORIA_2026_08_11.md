...
| `09_Investigacion/Ciclo Alpha v2/fase_0_ruido/` | Leído completo (README, ARQUITECTURA_APP, ACTUALIZACION_DATA, HISTORIAL_RESULTADOS, RECOPILACION_DATOS_APP parcial) + conteo directo de CSVs |
