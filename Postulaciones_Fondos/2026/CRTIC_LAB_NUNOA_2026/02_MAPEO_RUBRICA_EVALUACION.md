...
| 2 | Experiencia y capacidades del equipo | 15% | Trayectoria vía CV/portafolio, experiencia en proyectos similares | CVs reales de Javier (IoT/firmware/MQTT, 15+ años) y Mauro (Data Science/ML/visualización, ver `../EQUIPO/`) | Portafolio del equipo en PDF (bases §3.2) — no existe todavía, armar con capturas reales de `/today` + fotos del hardware KPCL |
