...
Su uso es solo interno para nosotros: Javy, Mauro y quienes administran el proyecto.
...
La experiencia debe quedar pensada para el uso interno de Javy, Mauro y administradores del proyecto.

## 12. Documentos relacionados

- [CHATBOT_GATO_KITTYPAU.md](CHATBOT_GATO_KITTYPAU.md) - especificacion integral del gato visible para cliente.
- [CHATBOT_GATO_CONTEXTO_REAL_KITTYPAU.md](CHATBOT_GATO_CONTEXTO_REAL_KITTYPAU.md) - contexto real del producto para el gato visible.
- [CHATBOT_GATO_FLUJO_REAL_KITTYPAU.md](CHATBOT_GATO_FLUJO_REAL_KITTYPAU.md) - flujo real y futuro del gato visible.
- [CHATBOT_GATO_STATE_MACHINE.md](CHATBOT_GATO_STATE_MACHINE.md) - maquina de estados del gato visible.
- [PLAN_CHATBOT_ADMIN_KITTYPAU.md](PLAN_CHATBOT_ADMIN_KITTYPAU.md) - plan paso a paso para implementar el chatbot de admin.
