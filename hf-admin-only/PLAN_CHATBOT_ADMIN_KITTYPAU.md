...
Construir un chatbot interno de administracion, simple y liviano, ubicado en el hero de admin, que permita a Javy, Mauro y administradores consultar la totalidad del proyecto de Kittypau sin mezclarse con el gato visible para cliente.
...
- el chatbot de admin ya tiene su especificacion canonica en `CHATBOT_ADMIN_KITTYPAU.md`.
...
1. Confirmar que `CHATBOT_ADMIN_KITTYPAU.md` define el alcance total del chatbot.
...
- `CHATBOT_ADMIN_KITTYPAU.md` como especificacion integral.
...
- [CHATBOT_ADMIN_KITTYPAU.md](CHATBOT_ADMIN_KITTYPAU.md) -> especificacion integral del chatbot de admin.
