...
```powershell
$env:FORCE_LOCAL_CSV='1'; python Docs/investigacion/plot_kpcl_experimento.py
```
...
#### [`abrir_kpcl_dashboard.ps1`](abrir_kpcl_dashboard.ps1)
...
#### [`kpcl0034_full_eventos.csv`](kpcl0034_full_eventos.csv)
...
#### [`kpcl0034_sin_batera_actual.csv`](kpcl0034_sin_batera_actual.csv)
...
#### [`kpcl0036_sin_batera_actual.csv`](kpcl0036_sin_batera_actual.csv)
