...
| Script dashboard KPCL (`serve_kpcl_dashboard.py`) | Sin cambios | `Docs/investigacion/` | Ya funciona; usarlo para identificar candidatos de anotación |
| `abrir_kpcl_dashboard.ps1` | Sin cambios | `Docs/investigacion/` | Ya funciona |
