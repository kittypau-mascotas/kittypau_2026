...
2. [`FUENTE_DE_VERDAD.md`](FUENTE_DE_VERDAD.md) - reglas canonicas de activos, legacy, tablas y flujos.
3. [`PLAN_MAESTRO.md`](PLAN_MAESTRO.md) - guia maestra viva de producto, arquitectura y estrategia.
4. [`SQL_MAESTRO.md`](SQL_MAESTRO.md) - orden sugerido para la base de datos.

## Capas de lectura
- Producto y arquitectura: `PLAN_MAESTRO.md`, `ARQUITECTURA_PROYECTO.md`, `DOC_MAESTRO_DOMINIO.md`
- Operacion y calidad: `ESTADO_AVANCE.md`, `PRUEBAS_E2E.md`, `GUIA_DECISION.md`
