...
## Objetivo
Definir controles minimos para proteger datos, API, MQTT y credenciales.
...
- Datos personales (email, ubicacion, habitos).

---

## 2) Controles minimos (obligatorios)
1. **RLS en Supabase**
...
4. **Credenciales MQTT**
   - Usuario y password unicos.
   - Rotacion trimestral.
5. **Rate limiting (minimo)**
...
## 7) Respuesta a incidentes (basico)
