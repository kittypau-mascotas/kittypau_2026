...
Se conserva como puntero historico para no perder el registro de:
- validacion CLI
- verificacion en Vercel / Supabase
- health-check manual
- pruebas de roles y acceso
- criterios de aceptacion ya cubiertos
