...
- `log10(x + 1)` es un paso de **ingestión**: se aplica server-side **después de vlidar** (ej. Zod) y **antes de persistir** en DB, para reducir skew/outliers sin eliminar eventos.
