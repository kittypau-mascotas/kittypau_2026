...
**Destino:** `Ciclo Gamma/fase_2_dataset/scripts/g03_build_train_dataset.py`
**Prerequisito:** `readings_features.parquet` generado
**Salidas:**
- `Ciclo Gamma/fase_2_dataset/data/train/X_train.parquet`
- `Ciclo Gamma/fase_2_dataset/data/train/y_train.parquet`
- `Ciclo Gamma/fase_2_dataset/data/train/X_val.parquet`
- `Ciclo Gamma/fase_2_dataset/data/train/y_val.parquet`
- `Ciclo Gamma/fase_2_dataset/data/train/X_test.parquet` ← **SELLAR — no abrir hasta G-Final**
- `Ciclo Gamma/fase_2_dataset/data/train/y_test.parquet` ← **SELLAR**
- `Ciclo Gamma/fase_2_dataset/data/train/dataset_meta.json`
