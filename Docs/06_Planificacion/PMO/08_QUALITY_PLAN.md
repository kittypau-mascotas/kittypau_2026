...
| Base de datos | Migraciones versinadas, RLS activo, constraints vlidados |
...
| Cobertura de tipos TypeScript | Sin `any` explcito en codigo nuevo | ESLint no-explicit-any |
| Latencia API (p95) | < 500ms | Vercel Analytics |
| Latencia datos IoT (sensor -> dashboard) | < 10 segndos | Medicion manual en pruebas |
...
| Tiempo de reconexin MQTT | < 30 segndos | Monitor serie + MQTT client |
| Tiempo entre lecturas | 5s (SENSORS), 30s (STATUS) | Logs MQTT |
| Duracion sin reinicio espontaneo | > 7 das continuos | Uptime MQTT / last_seen |
...
- Prohibido commitear `.env`, tokens o passwords (vlidado por Repo Policy Checks)
...
- [ ] Tension de alimentacin correcta (3.3V en pines MCU)
...
- [ ] Factor de calibracion vlidado con pesas de referencia (100g, 200g)
- [ ] Temperatura y humedad leyendo valores en rango esperado
- [ ] Sensor de luz LDR respondiendo a cambios de iluminacion

**Conectividad**
- [ ] Dispositivo publica en topic KPCLXXXX/SENSORS cada 5 segndos
- [ ] Dispositivo publica en topic KPCLXXXX/STATUS cada 30 segndos
...
- [ ] Cable de alimentacin sin tension sobre el conector
...
4. Esperar estabilizacion (30 segndos)
5. Colocar peso de referencia conocido (recomendado: 100g)
6. Esperar 30 segndos con peso estable
...
| Alto | Funcionalidad principal bloqueada para el usuario | < 3 das |
...
- [ ] Prueba de 24h de operacin continua sin reinicios
...
_Documento anterior: [07_STAKEHOLDERS.md](07_STAKEHOLDERS.md) | Siguente: [09_COMMUNICATIONS.md](09_COMMUNICATIONS.md)_
