...
## Fondo 1 — CORFO Semilla Inicia

### Datos clave

| Campo | Detalle |
|-------|---------|
| Organizacion | CORFO (Corporacion de Fomento de la Produccion) |
...
CORFO Semilla Inicia busca **emprendimientos innovadores en etapa muy temprana**. El enfasis esta en el potencial de mercado, la propuesta de valor diferenciada y la capacidad del equipo para ejecutar. No requiere ventas ni empresa constituida.

### Documentos PMO a priorizar

| Prioridad | Documento | Secciones clave |
|-----------|-----------|----------------|
| CRITICO | [04_BUSINESS_CASE.md](04_BUSINESS_CASE.md) | Seccion 1 (problema), 2 (solucion), 3 (mercado), 7 (uso del fondo) |
| CRITICO | [05_COST_BUDGET.md](05_COST_BUDGET.md) | Seccion 5 (presupuesto CORFO), tabla por categorias |
| ALTO | [01_PROJECT_CHARTER.md](01_PROJECT_CHARTER.md) | Secciones 2, 3, 5, 10 |
| ALTO | [03_SCHEDULE.md](03_SCHEDULE.md) | Fases 1 y 2, hitos con fechas |
| MEDIO | [06_RISK_REGISTER.md](06_RISK_REGISTER.md) | R01, R02, R03 + estrategias |

### Checklist de postulacion CORFO Semilla Inicia

**Documentos administrativos**

- [ ] Cedula de identidad vigente (ambos fundadores)
- [ ] Declaracion jurada simple (sin inicio de actividades o inicio reciente)
...
- [ ] Descripcion de la solucion innovadora (max 500 caracteres)
- [ ] Mercado objetivo y tamano estimado
- [ ] Modelo de negocio (como genera ingresos)
- [ ] Descripcion del equipo
- [ ] Presupuesto por categoria (usar Seccion 5 de 05_COST_BUDGET.md)

**Presentacion del proyecto (si la exigen)**

- [ ] Maximo 10 slides o equivalente
- [ ] Incluir: problema, solucion, mercado, modelo de negocio, equipo, presupuesto, roadmap
- [ ] Foto o video del prototipo funcionando (8 dispositivos activos)
...
### Adaptaciones especificas para CORFO

- Enfatizar **impacto social** (salud animal, ahorro en veterinaria)
- Mencionar **potencial de empleo** (manufactura local, desarrollo de software)
- Usar **CLP como moneda principal** en todo el presupuesto
- Destacar que es **primer producto IoT veterinario fabricado en Chile**

---

## Fondo 2 — StartUp Chile BIG 12

### Datos clave

| Campo | Detalle |
|-------|---------|
| Organizacion | StartUp Chile (CORFO) |
| Programa | BIG (Build / Ignite / Growth) |
...
### Adaptaciones especificas para StartUp Chile
...
## Fondo 3 — ANID Startup Ciencia

### Datos clave

| Campo | Detalle |
|-------|---------|
| Organizacion | ANID (Agencia Nacional de Investigacion y Desarrollo) |
| Programa | Startup Ciencia |
| Monto maximo | $134.550.000 CLP |
| Cofinanciamiento | 85% ANID / 15% empresa |
| Convocatoria esperada | ~Jul-Ago 2026 |
| Cierre estimado | ~Sep 2026 |
| Requiere empresa | **Si, constituida en Chile < 10 anos** |
| Requiere equipo | **Minimo 3 personas con roles definidos** |
| Dedicacion | Director: 20h/sem, Gerente: 40h/sem, Tecnico: 40h/sem |
...
| Prioridad | Documento | Secciones clave |
|-----------|-----------|----------------|
| CRITICO | [01_PROJECT_CHARTER.md](01_PROJECT_CHARTER.md) | Secciones completas + agregar base cientifica |
| CRITICO | [02_SCOPE_WBS.md](02_SCOPE_WBS.md) | WBS detallado con entregables tecnicos |
...
- [ ] Empresa constituida y activa en SII
- [ ] Ventas anuales < 25.000 UF (~$950M CLP)
- [ ] Empresa < 10 anos desde constitucion
- [ ] Equipo de al menos 3 personas con roles definidos y dedicacion comprobable
- [ ] Director del proyecto: min 20h/semana dedicadas
- [ ] Gerente de proyecto: min 40h/semana (puede ser externo)
- [ ] Personal tecnico-cientifico: min 40h/semana
...
| Monto maximo | $28M CLP (etapa 1) + $22M (etapa 2) |
| Convocatoria esperada | ~Ene 2027 |
| Requiere | **Ventas y clientes activos** |
| URL | https://www.corfo.cl/sites/cpp/inf/semilla-expande |

### Nota

Kittypau debe tener ventas reales y clientes activos para calificar. **Prioridad: 2027.**
Comenzar a documentar ventas y testimonios de clientes desde el piloto (mid-2026).

---

## Calendario de postulaciones 2026-2027
...
Sep  01 -----> Postular ANID Startup Ciencia
Oct  01 -----> Postular StartUp Chile BIG 12

2027
Ene  15 -----> Vigilar apertura CORFO Semilla Expande
Feb  28 -----> Postular Semilla Expande (si hubo ventas)
```

---

## Documentos transversales (sirven para todos los fondos)
...
## Tips generales de postulacion

1. **Leer las bases completas** antes de adaptar cualquier documento
2. **Usar el lenguaje del fondo**: si hablan de "impacto", usar esa palabra
