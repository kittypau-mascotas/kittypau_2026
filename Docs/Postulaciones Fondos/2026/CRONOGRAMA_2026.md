...
- Semana 1-2: lectura de bases y matriz de elegibilidad.
- Semana 3-4: borradores de formulario + presupuesto.
- Semana 5-6: anexos (legales, CV, evidencia tecnica).
- Semana 7: video pitch y deck final.
- Semana 8: QA final y envio.

## Responsables sugeridos
- Lider postulacion: TODO
- Responsable legal: TODO
- Responsable financiero: TODO
- Responsable tecnico: TODO
