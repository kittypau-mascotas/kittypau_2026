...
- `.../01_CORFO_Semilla_Inicia/Resumen_Ejecutivo_CORFO.md`
- `.../01_CORFO_Semilla_Inicia/3_Formularios/CORFO_Semilla_Inicia_2025_Draft.md`
...
- [ ] Consolidar anexos tecnicos y evidencia de validacion.
