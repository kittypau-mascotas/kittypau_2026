...
> Documento canonico de auditoria tecnica para el archivo `Docs/pruebas_kpcl/kpcl0036_error_peso_sinbateria.csv`.
...
- `Docs/pruebas_kpcl/kpcl0036_error_peso_sinbateria.csv`
...
- `Docs/pruebas_kpcl/SQL_VALIDACION_KPCL0036_TARE_FILL.sql`
