...
-- current net food amount is 28 g, with no consumption or manual
-- weight adjustment between the previous observation and this one.
-- ============================================================
...
select
  ...
  jsonb_build_object(
    ...
    'notes', 'Current net weight recorded at 28 g without observed consumption or manual weight changes.'
  ),
  timestamptz '2026-04-06 16:23:08-04'
from device_ctx d;
